		...
		<?php }
			...
			?>
              <tr>
                ...
                <td class="ctr">
                  <div class="btn-group">
                   <a target="_blank" class="btn btn-info btn-lg" href="edit.php?id=<?php echo $data['id_ptais'] ?>" rel="tooltip" data-original-title="Lihat File" data-placement="top" class="btn btn-primary">				
				<i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;
					<a target="_blank" class="btn btn-info btn-lg" href="delete.php?id=<?php echo $data['id_ptais'] ?>"  rel="tooltip" data-original-title="Lihat File" data-placement="top" class="btn btn-primary">
                    <i class="fa fa-trash-o" aria-hidden="true" onclick="return confirm('Apakah Anda Yakin ingin menghapus data ini?')" ></i> </a>&nbsp;
