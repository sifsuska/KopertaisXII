<?php
$title = "Peta Persebaran Institusi";
...
var officeLocations = [
<?php
$data = file_get_contents('http://localhost/kopertais/ambildata.php');
                $no=1;
                if(json_decode($data,true)){
                  $obj = json_decode($data);
                  foreach($obj->results as $item){
?>
[<?php echo $item->id_ptais ?>,
'<?php echo $item->nama_ptais ?>',
'<?php echo $item->alamat_ptais ?>', 
